                ...
                case "Flip":
                    String upperOrLower = tokens[1];
                     ...
                     if (upperOrLower.equals("Upper")){
                         activationKey = activationKey.replace(activationKey.substring(startIndex,endIndex),substring.toUpperCase());


                     }
                     else if (upperOrLower.equals("Lower")){
                         activationKey = activationKey.replace(activationKey.substring(startIndex,endIndex),substring.toLowerCase());
                     }
