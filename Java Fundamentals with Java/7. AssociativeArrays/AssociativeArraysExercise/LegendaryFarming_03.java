...
public class LegendaryFarming_03 {
    public static void main(String[] args) {
        ...
        //запис : материали и количество
        Map<String, Integer> items = new LinkedHashMap<>();
        items.put("shards", 0);
        items.put("fragments", 0);
        items.put("motes", 0);
        //запис : боклук и количество
        Map<String, Integer> junkItems = new LinkedHashMap<>();
        boolean isWin = false;
        while (!isWin) {
            String input = scanner.nextLine(); //четене от конзола
            String[] inputData = input.split(" "); //масив за данните от конзолата
